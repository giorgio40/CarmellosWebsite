    ...
    >
      <animated.div style={props}>
        ...
        <p className="item-description">
          3 large artichoke hearts, stuffed with mozarella cheese, breaded,
        ...
        <p className="item">Stuffed Mushroom Caps $12</p> 
        <p className="item-description">
        ...
        <p className="item-description">
          Mussels, clams, bay scallops, shrimp, calamari, marinara sauce,
          linguini{" "}
        </p>
        ...
        <p className="item-description">
          littleneck clams, white or red sauce, linguini{" "}
        </p>
        <p className="item">Pollo Tirolese $23</p>
        <p className="item-description">
          Chicken breast, crabmeat stuffing, sliced artichoke hearts,
          mozzarella, lemon butter sauce, capellini{" "}
        </p>
